  ...
  return (
    ...
    {/* text block */}
        <div className='flex flex-col justify-center items-center text-center lg:pt-0 pt-10' data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom">
          ...
          {/* buttons */}
          <div className='flex lg:flex-row flex-col gap-10 mt-8' data-aos="fade-up" data-aos-duration="1500">
        ...
        {/* banner image */}
        <div className='bg-[#FDF2EC] mt-20 rounded-xl px-8' data-aos="flip-up" data-aos-duration="2000">
